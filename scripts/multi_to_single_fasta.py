...
# Example usage:
input_file = "/Users/kirstyn.brunker/GitHub/rabv_redcap/matched_sequences.fasta"  # Path to the input multifasta file
output_folder = "/Users/kirstyn.brunker/GitHub/rabv_redcap/split_fasta"  # Path to the output folder where single fasta files will be saved
